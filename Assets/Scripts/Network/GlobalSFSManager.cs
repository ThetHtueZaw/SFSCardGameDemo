 ...
 */
public class GlobalSFSManager : MonoBehaviour
{
    private static GlobalSFSManager _instance;

    public static GlobalSFSManager Instance
    {
        get
        {
            if (_instance == null)
                _instance = new GameObject("GlobalSFSManager").AddComponent<GlobalSFSManager>();
